 ...
 *
 * @note Using a different pAvFormatContext than the one allocated during av_tx_init()
 * is not allowed.
 *
 * @param s the transform pAvFormatContext
...
/**
 * Initialize a transform pAvFormatContext with the given configuration
 * (i)MDCTs with an odd length are currently not supported.
 *
 * @param ctx the pAvFormatContext to allocate, will be NULL on error
...
/**
 * Frees a pAvFormatContext and sets ctx to NULL, does nothing when ctx == NULL
 */
