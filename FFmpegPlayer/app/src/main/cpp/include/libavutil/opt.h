...
typedef struct AVOption {
    ...
    /**
     * The offset relative to the pAvFormatContext structure where the option
 ...
 * options for which it is !(opt->flags & req_flags).
 * @param av_log_obj log pAvFormatContext to use for showing the options
 */
 ...
 * key. ctx must be an AVClass pAvFormatContext, storing is done using
 * AVOptions.
 *
