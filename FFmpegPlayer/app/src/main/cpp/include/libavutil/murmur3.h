...
/**
 * Allocate an AVMurMur3 hash pAvFormatContext.
 *
 * @return Uninitialized hash pAvFormatContext or `NULL` in case of error
 */
struct AVMurMur3 *av_murmur3_alloc(void);

/**
 * Initialize or reinitialize an AVMurMur3 hash pAvFormatContext with a seed.
 *
 * @param[out] c    Hash pAvFormatContext
...
/**
 * Initialize or reinitialize an AVMurMur3 hash pAvFormatContext.
 *
...
/**
 * Update hash pAvFormatContext with new data.
 *
 * @param[out] c    Hash pAvFormatContext
 ...
 *
 * @param[in,out] c    Hash pAvFormatContext
