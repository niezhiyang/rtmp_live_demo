...
/**
 * Main Vulkan pAvFormatContext, allocated as AVHWDeviceContext.hwctx.
 * All of these can be set before init to change what the pAvFormatContext uses
 */
typedef struct AVVulkanDeviceContext {
     ...
     * If supplying your own device pAvFormatContext, set this to an array of strings, with
     ...
     * If supplying your own device pAvFormatContext, these fields takes the same format as
 ...
 *
 * If all three queue family indices in the device pAvFormatContext are the same,
